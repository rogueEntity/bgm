...
CREATE TABLE tichu_news_events (
                                   ...
                                   CONSTRAINT tichu_news_events_user_id_fkey
                                       FOREIGN KEY (user_id)
                                           REFERENCES users(id)
                                           ON DELETE CASCADE
                                           ON UPDATE NO ACTION,

                                   CONSTRAINT tichu_news_events_match_id_fkey
                                       FOREIGN KEY (match_id)
                                           REFERENCES matches(id)
                                           ON DELETE CASCADE
                                           ON UPDATE NO ACTION
...
CREATE UNIQUE INDEX tichu_news_events_event_key_key
    ON tichu_news_events (event_key);

CREATE INDEX tichu_news_events_event_type_occurred_at_idx
    ON tichu_news_events (event_type, occurred_at);

CREATE INDEX tichu_news_events_user_id_occurred_at_idx
    ON tichu_news_events (user_id, occurred_at);

CREATE INDEX tichu_news_events_match_id_idx
    ON tichu_news_events (match_id);

CREATE INDEX tichu_news_events_achievement_id_idx
    ON tichu_news_events (achievement_id);
...
-- Yacht achievements and badges
-- CreateTable
CREATE TABLE "yacht_user_achievements" (
    "id" SERIAL NOT NULL,
    "user_id" UUID NOT NULL,
    "achievement_id" VARCHAR(100) NOT NULL,
    "progress" INTEGER NOT NULL DEFAULT 0,
    ...
    CONSTRAINT "yacht_user_achievements_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "yacht_user_badges" (
    "id" SERIAL NOT NULL,
    "user_id" UUID NOT NULL,
    "badge_id" VARCHAR(100) NOT NULL,
    "earned_at" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "yacht_user_badges_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "yacht_user_equipped_badges" (
    "id" SERIAL NOT NULL,
    "user_id" UUID NOT NULL,
    "badge_id" VARCHAR(100) NOT NULL,
    "slot" INTEGER NOT NULL,
    ...
    CONSTRAINT "yacht_user_equipped_badges_pkey" PRIMARY KEY ("id")
);

-- CreateIndex
CREATE INDEX "yacht_user_achievements_user_id_idx" ON "yacht_user_achievements"("user_id");

-- CreateIndex
CREATE INDEX "yacht_user_achievements_achievement_id_idx" ON "yacht_user_achievements"("achievement_id");

-- CreateIndex
CREATE UNIQUE INDEX "yacht_user_achievements_user_id_achievement_id_key" ON "yacht_user_achievements"("user_id", "achievement_id");

-- CreateIndex
CREATE INDEX "yacht_user_badges_user_id_idx" ON "yacht_user_badges"("user_id");

-- CreateIndex
CREATE INDEX "yacht_user_badges_badge_id_idx" ON "yacht_user_badges"("badge_id");

-- CreateIndex
CREATE UNIQUE INDEX "yacht_user_badges_user_id_badge_id_key" ON "yacht_user_badges"("user_id", "badge_id");

-- CreateIndex
CREATE INDEX "yacht_user_equipped_badges_user_id_idx" ON "yacht_user_equipped_badges"("user_id");

-- CreateIndex
CREATE INDEX "yacht_user_equipped_badges_badge_id_idx" ON "yacht_user_equipped_badges"("badge_id");

-- CreateIndex
CREATE UNIQUE INDEX "yacht_user_equipped_badges_user_id_slot_key" ON "yacht_user_equipped_badges"("user_id", "slot");

-- CreateIndex
CREATE UNIQUE INDEX "yacht_user_equipped_badges_user_id_badge_id_key" ON "yacht_user_equipped_badges"("user_id", "badge_id");

-- AddForeignKey
ALTER TABLE "yacht_user_achievements" ADD CONSTRAINT "yacht_user_achievements_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "yacht_user_badges" ADD CONSTRAINT "yacht_user_badges_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "yacht_user_equipped_badges" ADD CONSTRAINT "yacht_user_equipped_badges_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
