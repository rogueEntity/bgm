...
export const NORMAL_YAKU: Yaku[] = [
  ...
  { id: "daisuushi", name: "대사희", han: { closed: 13, open: 13 }, isMengenOnly: false, isYakuman: true, yakumanMultiplier: 1, exclusive: ["kokushi", "kokushi_13_wait", "daisangen", "shousuushi", "ryuuiisou", "chinroutou", "chuurenpoutou", "junsei_chuurenpoutou"] },
